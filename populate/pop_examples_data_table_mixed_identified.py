...
example_info.title       = 'Identified Nested Table'
example_info.permanent_slug = 'mtable3'

example_info.description = """
An example of identified data tables nested in a layout table.
"""
...
rr2 = rule_reference_object("TABLE_5", "pass", "pass", "TABLE_5_T1", "", "")
...
example_info.rule_references = [rr1,rr2,rr4,rr5,rr6]
example_info.html     = """
