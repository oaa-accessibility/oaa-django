...
example_info.title       = 'Naming data table using aria-label'
example_info.permanent_slug = 'dtable8'

example_info.description = """
Simple example of a bus schedule made with a data table named using aria-label.
"""
...
example_info.html     = """
  <table aria-describedby="id_desc" aria-label="Bus Schedule">
    <h1 id="id_desc">Bus Schedule for First Street and Illinois Street</h1>
    <tr class="top">
      <th>Route</th>
