...
example_info.title       = 'Layout table using links'
example_info.permanent_slug = 'ltable1'

example_info.description = """
Example of an accessible layout table with links.
"""
...
rr4 = rule_reference_object("TABLE_5", "pass", "pass", "TABLE_5_T3", "", "")
