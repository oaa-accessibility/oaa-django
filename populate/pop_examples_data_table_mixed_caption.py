...
example_info.title       = 'Using caption to add accessible names to data tables'
example_info.permanent_slug = 'mtable6'
...
<table role="presentation">
  <caption>NCAA Basketball Rankings by Conference</caption>
  </tr>
  <tr role="presentation">
    <td role="presentation">
      <table>
        <caption>Big 10</caption>
        <tr>
          <th>Team</th>
          <th>Conf</th>
          <th>Overall</th>   
