...
example_info.title       = 'Accessible Layout Table'
example_info.permanent_slug = 'ltable3'

example_info.description = """
An example of a more complex layout table that properly sequences table elements.
"""
...
rr2 = rule_reference_object("LAYOUT_2", "pass", "pass", "LAYOUT_2_T3", "", "")
rr3 = rule_reference_object("LAYOUT_1", "pass", "pass", "LAYOUT_1_T3", "", "")
    ...
    <td role="presentation">
      <table role="presentation">
        <tr role="presentation">
          ...
          <td role="presentation"><h2>Clubs</h2><br>
          ...
          <td role="presentation"><h2>Events</h2>
