...
ref = add_browser_compatibility( example1, win_ie80, 'c')
ref = add_browser_compatibility( example1, win_firefox36, 'c')
ref = add_browser_compatibility( example1, win_safari50, 'c')
ref = add_browser_compatibility( example1, win_opera10, 'c')
ref = add_browser_compatibility( example1, mac_safari50, 'c')
ref = add_browser_compatibility( example1, mac_firefox36, 'c')
ref = add_browser_compatibility( example1, mac_opera10, 'c')
