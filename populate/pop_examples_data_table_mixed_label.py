...
example_info.title       = 'Using aria-label to add accessible names to data tables'
example_info.permanent_slug = 'mtable7'
...
<table role="presentation">
  <tr role="presentation"><h1>NCAA Basketball Rankings by Conference</h1></tr>
  </tr>
  <tr role="presentation">
    <td role="presentation">
    <h2>Big 10</h2>
      <table aria-label="id_big10">
        <tr>
          <th>Team</th>
          <th>Conf</th>
          <th>Overall</th>   
